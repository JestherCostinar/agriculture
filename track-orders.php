			...
			<div class="container">
				<div class="row">
					...
					<div class="site-faq-accordion accordion" id="accordionExample">
						<div class="card">
						<?php $i=1; foreach(get_tracking($reference) as $track) { ?>
					...
					<div class="row">
						<div class="col-md-4 col-12">
							...
							<label>
								...
								Address: <?=$billingTrack['address']?> <?=$billingTrack['state']?>
								<br><?=$billingTrack['city']?>
						...
						<div class="col-md-4 col-12">
							...
							<label>
								Name: <?=$shippingTrack['shipping_firstname']?> <?=$shippingTrack['shipping_surname']?>
								<br>
								Contact: <?=$shippingTrack['contact']?><br>
								Address: <?=$shippingTrack['address']?> <?=$shippingTrack['state']?>
								<br><?=$shippingTrack['city']?>
						...
						<div class="login-form">
							<div class="row">
								<div class="col-md-12 col-12 mb--20">
									...
									<input class="mb-0" pattern="[^()/<>[]\,'|\x22]+" type="text" name="reference"
										required minlength="4" maxlength="15">
								</div>

								<div class="col-md-12">
									<div class="d-flex align-items-center flex-wrap">
										<button type="submit" name="btn-track-now"
											class="btn btn-success text-white w-100">Track Now</button>
									</div>
								</div>
