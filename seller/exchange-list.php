                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="" class="breadcrumb-item active" aria-current="page">Lists</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach(view_my_exchange_lists_all($_SESSION['vendor_id'],$_GET['reference']) as $orders) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:1px"> <a href="exchange-list.php?reference=<?=$orders['reference']?>" >View</a></td>
                                            </tr>
                                            <?php } ?>
                                        <?php } ?>
                                    </tbody>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table datatable-responsive">
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach(view_my_exchange_lists($_SESSION['vendor_id']) as $orders) { ?>
