...
<?php if(get_order_details($_GET['reference'],$_SESSION['vendor_id'])->num_rows == 0) {
	header('location:transaction.php');
}
?>

<?php foreach(get_order_details($_GET['reference'],$_SESSION['vendor_id']) as $orders) { ?>
...
<?php if(isset($_POST['btnTracking'])) { ?>
    <?php 
        $pstatus = post('pstatus');
        $message = post('message');
        update_transaction_status($_GET['reference'],$_SESSION['vendor_id'],$message,$pstatus); 
    ?>
<?php } ?>
<body>
            ...
            <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <label>
                                    ...
                                    <br>
                                    <div class="btn-group">
                                    <?php if($method_of_payment == 'Bank Transfer' || $method_of_payment == 'GCash') { ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        <div class="card">
                            <div class="card-body">
                                <form data-parsley-validate action="?reference=<?=$_GET['reference']?>&timeline=true" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-primary btn-sm btn-block" name="btnTracking" type="submit">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="list-feed">
                                    <?php foreach(get_tracking($_GET['reference']) as $track) { ?>
