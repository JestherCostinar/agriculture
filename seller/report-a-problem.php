...
if(isset($_POST['btnEmail'])) {
    ...
    report_vendor($firstname,$lastname,$email,$message,$subject);
}
?>
<style>
        ...
        <div class="page-header page-header-light">
            <div class="page-header-content d-sm-flex">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Report A Problem</span></h4>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12 mb--20">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly value="<?=$details['firstname']?>" type="text" name="topic" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12 mb--20">
                                    <div class="form-group">
                                        <label>Surname</label>
                                        <input class="form-control" readonly value="<?=$details['surname']?>" type="text" name="topic" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12 mb--20">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly value="<?=$details['email']?>" type="text" name="topic" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12 mb--20">
                                    ...
                                    <button type="submit" name="btnEmail" class="btn btn-success text-white w-100">Submit</button>
