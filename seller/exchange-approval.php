                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <a href="?approve=true&approver=<?=$_SESSION['vendor_id']?>&reference=<?=$_GET['reference']?>" onclick="return confirm('Are you sure you want to approve this request?')" class="btn btn-primary">Approve</a>
                            
                            
                            <a href="?approve=2&approver=<?=$_SESSION['vendor_id']?>&reference=<?=$_GET['reference']?>" onclick="return confirm('Are you sure you want to reject this request?')" class="btn btn-danger">Reject</a>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <table class="table datatable-responsive">
                                    ...
                                    <tbody>
                                    <?php $i=1; foreach(view_my_exchange_approval_list($_SESSION['vendor_id'],$_GET['reference']) as $orders) { ?>
                                        ...
                                        <?php if($_SESSION['vendor_id'] != $orders['requestor_id']) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:1px"> <a href="exchange-approval.php?reference=<?=$orders['reference']?>" >View</a></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                    </tbody>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table datatable-responsive">
                                    ...
                                    <tbody>
                                    <?php $i=1; foreach(view_my_exchange_approval($_SESSION['vendor_id']) as $orders) { ?>
                                        <?php if($_SESSION['vendor_id'] != $orders['owner_id']) { ?>
