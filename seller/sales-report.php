                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="sales-report.php" class="breadcrumb-item">Reports</a>
                            <a href="" class="breadcrumb-item active" aria-current="page">Sales</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive" >
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i=1;?>
                                    <?php $total = 0?>
                                    <?php foreach(get_all_order_details($from,$to,$_SESSION['vendor_id']) as $orders) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:1px;text-align:right">
                                            ₱<?=number_format($orders['price'],2)?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan=6></td>
                                        <td></td>
                                        <td style="width:1px;text-align:right">₱<?=number_format($total,2)?>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
