    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-light">
                <div class="page-header-content d-sm-flex d-md-flex d-xs-flex">
                    ...
                    <div class="col-md-6 col-lg-3 col-12">
                        <div class="card card-body">
                            <div class="media">
                                ...
                                <div class="media-body text-right">
                                    <h3 class="font-weight-semibold mb-0">₱<?=get_transaction_sales()?></h3>
            ...
            var _googleColumnBasic = function () {
                ...
                function drawColumn() {
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ['Year','Cash on Delivery','GCash'],
                        <?php foreach(get_all_payment_method_used() as $transaction) { ?>
                            ['<?=date('M',strtotime($transaction['created_at']))?> <?=date('Y',strtotime($transaction['created_at']))?>', <?=count_cod($transaction['month'],$transaction['year'])?>,<?=count_gcash($transaction['month'],$transaction['year'])?>],
                        <?php } ?>
                    ]);
                ...
                var _googleLineBasic = function() {
                    ...
                    function drawLineChart() {
                        ...
                        // Data
                                var data = google.visualization.arrayToDataTable([
                                    ['Year','Sales'],
                                    <?php if(get_all_sales_transaction()->num_rows > 0) { ?>
