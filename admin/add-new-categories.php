            ...
            <div class="page-header page-header-light">
                <div class="page-header-content d-sm-flex">
                    <div class="page-title">
                        <h4><span class="font-weight-semibold">Categories</span>
                            - Create</h4>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="add-new-categories.php" class="breadcrumb-item">Categories</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" pattern="[a-zA-Z ]*" style="text-transform: capitalize;" class="form-control" name="parent" required minlength="2" maxlength="20">
                                            </div>
                                        </div>
                                ...
                                <table class="table datatable-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0)" onclick="modal_default_update('<?=$data['id']?>','<?=$data['images']?>','<?=$data['parent']?>','<?=$data['is_featured']?>')"><i class="icon-eye"></i></a> | <a href="?delete=true&id=<?=$data['id']?>" onclick="return confirm('Are you sure you want to delete this category?')" class="text-danger"><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                    ...
                                    <div class="col-md-8 col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="">Category</label>
                                                    <input type="text" pattern="[a-zA-Z]*" pattern="[^()/<>[]\,'|\x22]+" style="text-transform: capitalize;" class="form-control" name="update_parent"
                                                        id="update_parent" required minlength="2" maxlength="20">
                                                </div>
                                            </div>
