            ...
            <div class="page-header page-header-light">
                <div class="page-header-content d-sm-flex">
                    <div class="page-title">
                        <h4><span class="font-weight-semibold">Sub Categories</span>
                            - Create</h4>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="add-new-sub-categories.php" class="breadcrumb-item">Sub Categories</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" pattern="[a-zA-Z ]*" autofocus style="text-transform: capitalize;" class="form-control" name="child" required minlength="2" maxlength="20">
                                            </div>
                                        </div>
                                ...
                                <table class="table datatable-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0)" onclick="modal_default_update('<?=$data['id']?>','<?=$data['product_categories_id']?>','<?=$data['child']?>')"><i class="icon-eye"></i></a> | <a href="?delete=true&id=<?=$data['id']?>" onclick="return confirm('Are you sure you want to delete this sub category?')" class="text-danger"><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div id="modal_default_update" class="modal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content ">
                            <div class="modal-header">
                                <h5 class="modal-title update-modal-title">Update Sub Categories</h5>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="">Sub Category</label>
                                            <input type="text" pattern="[a-zA-Z ]*" style="text-transform: capitalize;" class="form-control" id="update_child" name="update_child" required minlength="2" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                            </div>
