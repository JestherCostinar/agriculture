...
<body>
    <div class="site-wrapper">
        ...
        <!-- Promotion Block 2 -->
        <main class="section-padding shop-page-section"  style="background:#fff">
            <div class="container" >
                ...
                <div class="shop-product-wrap list grid with-pagination row border grid-four-column  me-0 ms-0 g-0" >
